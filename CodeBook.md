...
Research: Human Activity Recognition Using Smartphones Dataset

The experiments have been carried out with a group of 30 volunteers within an age bracket of 19-48 years. 

There are 6 activities involved in this research:
* WALKING
* WALKING_UPSTAIRS
* WALKING_DOWNSTAIRS
* SITTING
...
However, in this project, only two variables are used which are 
- mean(): Mean value
- std(): Standard deviation
